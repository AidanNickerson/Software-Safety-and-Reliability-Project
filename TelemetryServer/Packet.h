...
enum PacketType
{
    ...
    // new packet types for file download feature (renamed to avoid macro conflicts)
    PKT_REQ_DOWNLOAD,   // client request
    PKT_FILE_INFO,      // server metadata
    PKT_FILE_CHUNK,     // (optional, not used now)
    PKT_FILE_END,       // transfer complete
    PKT_ERROR_MSG       // error case
};
